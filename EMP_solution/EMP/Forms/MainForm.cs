...
namespace EMP
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            this.lblHello.Text = "Hello " + Constant.user_name;
            if (!Constant.isAdmin)
            {
        ...
        {
            btnExitTop.ForeColor = Color.FromArgb(222, 82, 70);
        }
        ...
        private void newBtn()
        {
            ...
            btn22.Click += new System.EventHandler(this.btnNewPlay_Click);
        ...
        private void FoucsToMain_trackBar_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            btnPlaylistShow.ForeColor = SystemColors.ButtonFace;
            foCUS.Focus();
        }

        private void btnPlaylistShow_Click_1(object sender, EventArgs e)
        {
        ...
        private void Main_cms_Opening(object sender, System.ComponentModel.CancelEventArgs e)
        {
